...
% Table with O2 and CO2
% \textbf{Biomass growth rate \unit{\mu} \unit{1/h}} & \textbf{Glucose uptake rate \unit{r} \unit{mmol/gDW/h}} & \textbf{CO$_2$ \unit{mmol/gDW/h}} & \textbf{O$_2$ \unit{mmol/gDW/h}} & \textbf{Glycerol secretion rate \unit{r_{gly}} \unit{mmol/gDW/h}} \\ \hline
% 0.049 & 0.476 & 1.171 & 1.083 & ~\\ 
% 0.100 & 1.114 & 2.521 & 2.521 & ~ \\ 
% 0.151 & 1.648 & 3.854 & 3.851 & $<0.02$\\ 
